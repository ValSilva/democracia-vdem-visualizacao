############################################
# Criar uma animação gráfica mostrando a evolução dos diferentes índices de democracia no Brasil entre 1900 e 2024, com base nos dados do projeto V-Dem (Varieties of Democracy).

install.packages("remotes")                     # permite instalar outros pacotes direto do GitHub
...
# Transforma os dados de formato Wider para longo, onde cada linha representa uma observação por ano e tipo de democracia.
...
animacion <- dependencia_long %>%
  ...
  ggtitle("Índices de Democracia no Brasil 1900-2024") + transition_reveal(year) +
  enter_fade() +
  exit_fade() + 
